...
pub async fn find_by_id(email_or_username: web::Path<String>, pool: web::Data<Pool>) -> Result<HttpResponse> {
    match account_service::find_by_id(&email_or_username.clone(), &pool) {
